...
<head>
  ...
  <title>Admin Login | Rahul Kumar Portfolio</title>
  <!-- Google Fonts -->
  ...
  <div class="login-card">
    ...
    <form action="<?= base_url('admin/login') ?>" method="POST">
      ...
      <div class="mb-4">
        ...
        <div class="form-text small mt-1">Default credentials: Username: <code>admin</code> | Password: <code>admin123</code></div>
      </div>

      <button type="submit" class="btn btn-primary w-100 py-2.5 fw-semibold" style="background: var(--admin-gradient); border: none; border-radius: 12px;">

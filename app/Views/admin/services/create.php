...
<div class="admin-table-wrapper max-w-800">
  <div class="d-flex align-items-center justify-content-between mb-4">
    <h5 class="fw-bold mb-0 text-white"><i class="fas fa-plus-circle text-primary me-2"></i>Add New Service</h5>
  ...
  <form action="<?= base_url('admin/services/store') ?>" method="POST">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        ...
        <input type="text" name="title" class="form-control bg-dark text-white border-secondary" placeholder="Web Development" value="<?= old('title') ?>" required>
      </div>

      <div class="col-md-6">
        <label class="form-label text-muted small">FontAwesome Icon Class *</label>
        <input type="text" name="icon" class="form-control bg-dark text-white border-secondary" placeholder="fas fa-laptop-code" value="<?= old('icon', 'fas fa-laptop-code') ?>" required>
      </div>

...
<div class="admin-table-wrapper max-w-800">
  <div class="d-flex align-items-center justify-content-between mb-4">
    <h5 class="fw-bold mb-0"><i class="fas fa-edit text-warning me-2"></i>Edit Skill #<?= esc($skill['id']) ?></h5>
  ...
  <form action="<?= base_url('admin/skills/update/' . $skill['id']) ?>" method="POST">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        ...
        <input type="text" name="name" class="form-control" value="<?= esc($skill['name']) ?>" required>
      </div>
      ...
      <div class="col-md-6">
        ...
        <input type="number" name="percentage" class="form-control" min="0" max="100" value="<?= esc($skill['percentage']) ?>" required>
      </div>

      <div class="col-md-6">
        <label class="form-label">FontAwesome Icon Class *</label>
        <input type="text" name="icon" class="form-control" value="<?= esc($skill['icon']) ?>" required>
      </div>

      <div class="col-md-6">
        <label class="form-label">Sort Order</label>
        <input type="number" name="sort_order" class="form-control" value="<?= esc($skill['sort_order']) ?>">
      </div>

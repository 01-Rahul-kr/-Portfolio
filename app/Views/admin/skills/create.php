...
<div class="admin-table-wrapper max-w-800">
  <div class="d-flex align-items-center justify-content-between mb-4">
    <h5 class="fw-bold mb-0"><i class="fas fa-plus-circle text-primary me-2"></i>Add New Skill</h5>
  ...
  <form action="<?= base_url('admin/skills/store') ?>" method="POST">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        ...
        <input type="text" name="name" class="form-control" placeholder="CodeIgniter 4" value="<?= old('name') ?>" required>
      </div>
      ...
      <div class="col-md-6">
        ...
        <input type="number" name="percentage" class="form-control" min="0" max="100" placeholder="90" value="<?= old('percentage', 85) ?>" required>
      </div>

      <div class="col-md-6">
        <label class="form-label">FontAwesome Icon Class *</label>
        <input type="text" name="icon" class="form-control" placeholder="fas fa-fire or fab fa-php" value="<?= old('icon', 'fas fa-code') ?>" required>
      </div>

...
<div class="admin-table-wrapper max-w-800">
  <div class="d-flex align-items-center justify-content-between mb-4">
    <h5 class="fw-bold mb-0"><i class="fas fa-envelope-open text-info me-2"></i>View Message #<?= esc($msg['id']) ?></h5>
    <div>
  ...
  <div class="row g-3 mb-4">
    <div class="col-md-6">
      <div class="p-3 rounded-3 border" style="background: var(--admin-input-bg); backdrop-filter: blur(12px);">
        <span class="text-muted small d-block">Sender Name</span>
        <strong class="fs-6"><?= esc($msg['name']) ?></strong>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="p-3 rounded-3 border" style="background: var(--admin-input-bg); backdrop-filter: blur(12px);">
        ...
        <strong class="fs-6"><?= esc($msg['email']) ?></strong>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="p-3 rounded-3 border" style="background: var(--admin-input-bg); backdrop-filter: blur(12px);">
        ...
        <strong class="fs-6"><?= esc($msg['phone'] ?: 'N/A') ?></strong>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="p-3 rounded-3 border" style="background: var(--admin-input-bg); backdrop-filter: blur(12px);">
        ...
        <strong class="fs-6"><?= date('F d, Y \a\t h:i A', strtotime($msg['created_at'])) ?></strong>
      </div>
    </div>
  </div>

  <div class="p-4 rounded-3 border" style="background: var(--admin-input-bg); backdrop-filter: blur(12px);">
    <h6 class="text-primary mb-2">Subject: <?= esc($msg['subject']) ?></h6>
    <hr style="border-color: var(--admin-card-border);">
    <p class="mb-0 style-message" style="white-space: pre-line; line-height: 1.7;"><?= esc($msg['message']) ?></p>
  </div>
</div>

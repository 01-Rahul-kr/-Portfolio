...
<div class="admin-table-wrapper max-w-800">
  <div class="d-flex align-items-center justify-content-between mb-4">
    <h5 class="fw-bold mb-0 text-white"><i class="fas fa-plus-circle text-primary me-2"></i>Add Social Link</h5>
  ...
  <form action="<?= base_url('admin/social-links/store') ?>" method="POST">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        ...
        <input type="text" name="platform" class="form-control bg-dark text-white border-secondary" placeholder="LinkedIn" value="<?= old('platform') ?>" required>
      </div>

      <div class="col-md-6">
        <label class="form-label text-muted small">FontAwesome Icon Class *</label>
        <input type="text" name="icon" class="form-control bg-dark text-white border-secondary" placeholder="fab fa-linkedin-in" value="<?= old('icon', 'fab fa-linkedin-in') ?>" required>
      </div>

      <div class="col-12">
        <label class="form-label text-muted small">Profile / Link URL *</label>
        <input type="url" name="url" class="form-control bg-dark text-white border-secondary" placeholder="https://linkedin.com/in/satyam-raj" value="<?= old('url') ?>" required>
      </div>

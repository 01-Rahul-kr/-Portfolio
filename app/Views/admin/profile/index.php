...
<div class="row g-4">
  ...
  <div class="col-lg-7">
    <div class="admin-table-wrapper">
      <h5 class="fw-bold mb-4"><i class="fas fa-user-cog text-primary me-2"></i>Account Information</h5>
      ...
      <form action="<?= base_url('admin/profile/update') ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
          ...
          <div class="col-12">
            ...
            <input type="file" name="avatar" class="form-control image-preview-input" accept="image/*">
          </div>

          <div class="col-12 text-center mt-3">
            <img src="<?= base_url($user['avatar']) ?>" alt="Avatar Preview" class="admin-avatar image-preview-target" style="width: 90px; height: 90px; border: 2px solid var(--primary-color);">
          </div>
  ...
  <div class="col-lg-5">
    <div class="admin-table-wrapper">
      <h5 class="fw-bold mb-4"><i class="fas fa-key text-warning me-2"></i>Change Password</h5>
